...
--
-- Promoted from the independently tested candidate:
-- supabase/migration-candidates/20260730070000_phase1r_d2_b2_business_checkout_claims.sql
--
-- This commit creates the managed migration FILE only. It DOES NOT apply SQL
-- to production or any connected database. Production application is a
-- separate controlled phase. Edge-function integration is also separate.
BEGIN;

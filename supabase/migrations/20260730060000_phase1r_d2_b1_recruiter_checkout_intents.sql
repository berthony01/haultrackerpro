...
--
-- This file is the ACTIVE managed-migration promotion of the previously
-- reviewed and real-PostgreSQL-tested candidate at:
--   supabase/migration-candidates/20260717235300_phase1g_r1a1_recruiter_checkout_intents.sql
--
-- The executable body below (first BEGIN; through final COMMIT;) is
-- BYTE-FOR-BYTE IDENTICAL to that candidate. It has not been redesigned,
-- reformatted, reordered, or made idempotent.
--
-- Creating and committing this file DOES NOT apply it to production.
-- Production application is a separate controlled phase.
BEGIN;

...
export const InviteEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>You've been invited to HaulTrackerPro</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            You've been invited to join <strong>HaulTrackerPro</strong> — the load, expense, and profit tracker built for owner-operators. Accept your invitation to get started.
          </Text>

...
export const RecoveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your HaulTrackerPro password</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            We received a request to reset the password for your HaulTrackerPro account. Click the button below to choose a new one.
          </Text>

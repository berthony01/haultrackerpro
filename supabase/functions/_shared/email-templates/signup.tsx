...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email to start tracking loads on HaulTrackerPro</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Thanks for signing up for <strong>HaulTrackerPro</strong>. You're one click away from tracking your loads, expenses, and profit per mile.
          </Text>
          <Text style={text}>
            Please confirm{' '}

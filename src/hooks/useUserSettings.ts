...
export type UserSettingsUpdate = Pick<TablesUpdate<'user_settings'>, 'default_rate_per_mile' | 'default_other_fees' | 'week_start_day' | 'currency' | 'company_name' | 'pay_type' | 'pay_percentage' | 'company_start_date' | 'tax_estimator_enabled' | 'federal_tax_percent' | 'state_tax_percent' | 'include_se_tax' | 'se_tax_percent' | 'buffer_percent' | 'tax_base_type'>;

...
const steps = [
  ...
  { num: '04', icon: ClipboardList, title: 'Post unlimited standard opportunities', desc: 'Post as many standard opportunities as you need — no per-plan post cap. Pay model, CPM/percentage/flat, deductions, deadhead, escrow, home time, equipment, sign-on. Clear structure means drivers can compare you on real numbers.' },
  ...
  { num: '06', icon: CreditCard, title: 'Upgrade for premium tools when needed', desc: 'Standard posting is always available to complete, active recruiter workspaces. Upgrade to Starter ($19), Growth ($49), or Fleet ($149) when you want premium visibility, recruiter reports, contract-management, AI-assisted risk review, and analytics. Billing is handled by Stripe — change or cancel anytime in Recruiter Settings.' },
...
const tips = [
  ...
  'Pause listings that are full instead of leaving them stale. Standard posting is unlimited for complete, active recruiter workspaces — upgrade only when you want premium visibility, reports, or contract-management tools.',
];

          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden border" style={{
                ...
                <img src={dashboardMockup} alt="HaulTrackerPro dashboard showing load tracking, net profit, and weekly earnings chart" className="w-full" width={1536} height={1024} fetchPriority="high" decoding="async" />
              </div>

...
const faqs: Faq[] = [
  ...
  { id: 'multi-stop', question: 'How does multi-stop tracking work?', answer: 'When logging a load, toggle "Multi-stop load?" to add intermediate stops between pickup and drop-off. Each stop can have a type (Pickup, Stop, Drop) and optional detention minutes. Loaded miles and deadhead miles remain totals for the whole load.' },
  ...
  { id: 'free-trial', question: 'What\'s included in the 14-day free trial?', answer: 'Every new account starts with a 14-day Pro trial — no credit card required. You get full access to AI Voice Logging, AI Receipt Scanning, Rate Con Screenshot Scanner, Driver Scorecard with coaching advice, Weekly Closeout with anomaly detection, all 5 performance charts, dollar-impact Smart Alerts, branded PDF reports, and full tax breakdowns. No restrictions — try everything before you commit.' },
  { id: 'upgrade-pro', question: 'How do I upgrade to Pro?', answer: 'Go to Settings → tap "Upgrade to Pro" or visit the Pricing page. You can choose monthly ($19.99/mo) or annual ($179.88/yr — save $60). Both start with a 14-day free trial. Payment is handled securely through Stripe.' },

    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 py-6 max-w-2xl mx-auto space-y-6 text-sm leading-relaxed text-foreground">
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">Standard opportunity posting readiness requires a recruiter name, a company name, a valid recruiter email, a company type, acceptance of the current posting terms, and a non-suspended account. A DOT or MC number is required only when the account's company type is Carrier / Motor Carrier. The Verified Recruiter badge is a separate review and does not gate standard posting. Submitted opportunities remain subject to moderation and may be flagged, unpublished, or removed at HaulTrackerPro's sole discretion. Recruiters are solely responsible for the accuracy and legality of opportunity listings, hiring practices, and communications with drivers. Misleading pay claims, fake postings, or harassing behavior may result in suspension of recruiter access. Driver applications are made available only to the recruiter who posted the opportunity the driver applied to, and a driver's private phone and email are released to that recruiter only after the driver approves a separate contact request.</p>
        </section>

        <section className="space-y-2">
          <h3 className="text-base font-bold">11. Recruiter Billing &amp; Subscriptions</h3>
          <p className="text-muted-foreground">Recruiter access does not require approval to post a standard opportunity once the readiness requirements in Section 10 are met. Active opportunity limits are: Recruiter Standard 1 active opportunity, Starter 5 active opportunities, Growth 15 active opportunities, and Fleet 25 active opportunities. Drafts are unlimited on every tier. New standalone Fleet checkout is currently unavailable, although an existing or agency-included Fleet entitlement may already exist on some accounts. Paid recruiter subscriptions layer additional features on top of standard posting, which may include priority placement, featured visibility, reports, analytics, contract workflow tools, and other premium recruiting tools. Losing a paid recruiter subscription may remove those paid features, but does not by itself revoke standard recruiter access unless the account violates platform rules or is suspended. Listings remain subject to moderation, accuracy requirements, and platform policies. HaulTrackerPro does not guarantee hires, applications, driver quality, earnings, or placement results. Contract workflow tools are informational and are not legal advice.</p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">Recruiter accounts must represent a legitimate motor carrier or an authorized recruiting partner and must provide truthful company information. Accounts whose company type is Carrier / Motor Carrier must provide a DOT or MC number. Authorized recruiting partners — such as third-party recruiters, staffing companies, and independent recruiters — may use recruiter access without a DOT or MC number for standard posting when the other readiness requirements in Section 10 are met. The Verified Recruiter badge remains a separate review and is not required to post. HaulTrackerPro may reject, suspend, or revoke recruiter access at any time, in its sole discretion, including for fraud signals, misrepresentation, or violations of these terms.</p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">Recruiters may use the application and profile information a driver submitted to their own listing, and only for the opportunity that driver applied to or inquired on. A driver's private phone number and email address are released to a recruiter only after the driver approves a separate contact request. Recruiters may not scrape or off-platform-solicit drivers sourced through HaulTrackerPro, may not contact drivers outside reasonable hours, and may not harass, threaten, retaliate against, or repeatedly contact a driver who has declined. Reported violations may result in immediate suspension.</p>
        </section>
